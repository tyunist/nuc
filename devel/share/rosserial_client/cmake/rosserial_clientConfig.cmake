...
if("TRUE" STREQUAL "TRUE")
  set(rosserial_client_SOURCE_PREFIX /home/nuc/catkin_ws/src/rosserial/rosserial_client)
  set(rosserial_client_DEVEL_PREFIX /home/nuc/catkin_ws/devel)
  ...
  set(rosserial_client_INSTALL_PREFIX /home/nuc/catkin_ws/install)
...
if(NOT "" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'rosserial_client' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nuc/catkin_ws/src/rosserial/rosserial_client/${idir}'.  Ask the maintainer 'Paul Bouchier <paul.bouchier@gmail.com>' to fix it.")
    endif()
